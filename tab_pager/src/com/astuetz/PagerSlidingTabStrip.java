...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private OnGlobalLayoutListener firstTabGlobalLayoutListener = new OnGlobalLayoutListener() {
        ...
        @Override
        public void onGlobalLayout() {
            View first = tabsContainer.getChildAt(0);
            View last = tabsContainer.getChildAt(tabCount-1);
            int totalWidth = 0;
            for (int i = 0; i < tabCount - 1; i++) {
                totalWidth = totalWidth + tabsContainer.getChildAt(i).getWidth();
            }
            ...
            if (isPaddingMiddle) {
                paddingLeft = getWidth() / 2 - first.getWidth() / 2;
                paddingRight = -paddingLeft + totalWidth - last.getWidth() / 2;
            }
